                    ...
                    <form style="width:925px;">
                        <div class="form-group" style="width:916px;">
                            ...
                            <div class="form-row" style="width:922px;padding:6px;font-size:15px;">
                                <div class="col-2 visible" id="districtOwner" style="width:149px;padding:0px;height:66px; "><label class="col-form-label">District:</label><select class="form-control" id="district" style="height:30px;width:145px;font-size:14px;padding:4px;"></select></div>
